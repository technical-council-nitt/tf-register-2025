    ...
    return (
        ...
        <img src="/register.svg" alt="Logo" style={{ width: '110px', aspectRatio: '96 / 20' }} />
            ...
            <div className="flex self-start ml-4  cursor-pointer my-4 justify-center items-center">
                <p>
                    <p className="text-2xl font-bold my-4">Privacy Policy</p>
                    <p className="text-sm my-6">Last updated on March 19th, 2024</p>
                    <p className="text-3xl my-6 font-bold">Introduction to Privacy Policy</p>
                    <p className="text-sm my-6">
                    This privacy policy (the "Privacy Policy") applies to your use of the website of Razorpay hosted
                    at <a className="underline underline-offset-4" href="https://razorpay.com">razorpay.com</a>, the Services (as defined under the Razorpay "Terms of Use") and Razorpay applications on
                    ...
                    you may have with the businesses listed on Razorpay.</p>
                    <p className="text-sm my-6">The terms "we"
                    ,
                    "our" and "us" refer to <a className="underline underline-offset-4" href="https://razorpay.com">Razorpay</a> and the terms "you"
                    ,
                    "your" and "User" refer to you, as a
                    user of <a className="underline underline-offset-4" href="https://razorpay.com">Razorpay</a>. The term "Personal Information" means information that you provide to us which
                    ...
                    use of Personal Information have been set-out below in order to ensure safe usage of the Website for you.</p><p className="text-sm my-6">
                    ...
                    you do not agree with these terms, do not use the Website.</p><p className="text-sm my-6">
                    ...
                    <p className="text-3xl font-bold my-6">Information we collect and how we use it</p>
                    <p className="text-sm my-6">We collect, receive and store your Personal Information. If you provide your third-party account credentials
                    ("<span className="font-bold">Third Party Account Information</span>") to us, you understand that some content and information in those
                    ...
                    features and services.</p><p className="text-sm my-6">
                    ...
                    such use.</p>
                    <p className="text-sm my-6">The Personal Information collected will be used only for the purpose of enabling you to use the services
                    ...
                    <p className="text-3xl font-bold my-6">Account information of Merchants</p><p className="text-sm my-6">
                    ...
                    card, debit card details, bank account and know your customer ("<span className="font-bold">KYC</span>") documents as per RBI regulations
                    ...
                    wish to receive such SMSs from us, please notify us at <a className="underline underline-offset-4" href="https://razorpay.com/support">razorpay.com/support</a> to stop receiving SMSs from us.
                    Razorpay assures that your Personal Information will not be made public or sold to any third party.</p><p className="text-sm my-6">
                    ...
                    servers.</p>
                    <p className="text-3xl font-bold my-6">Customer Information</p><p className="text-sm my-6">
                    ...
                    customer.</p>
                    <p className="text-3xl font-bold my-6">Activity</p>
                    <p className="text-sm my-6">We record information relating to your use of Razorpay, such as the searches you undertake, the pages you
                    ...
                    cannot be identified from this aggregate information.</p>
                    <p className="text-sm my-6">We own all the intellectual property rights associated with the Website and its contents. No right, title or
                    ...
                    arrangement, and assembly) of all the content on this Website, pursuant to applicable law.</p>
                    <p className="text-sm my-6">Our logos, product and service marks and/ or names, trademarks, copyrights and other intellectual property,
                    whether registered or not ("<span className="font-bold">Our IP</span>") are exclusively owned by us. Without our prior written permission, you
                    ...
                    <p className="text-3xl font-bold my-6">Cookies</p>
                    <p className="text-sm my-6">We send cookies to your computer in order to uniquely identify your browser and improve the quality of our
                    ...
                    your browser.</p>
                    <p className="text-3xl font-bold my-6">Enforcement</p>
                    <p className="text-sm my-6">We may use the information we collect in connection with your use of Razorpay (including your Personal
                    Information) in order to investigate, enforce, and apply our terms and conditions and Privacy Policy.</p>
                    <p className="text-3xl font-bold my-6">Transfer of information</p>
                    <p className="text-sm my-6">We do not share your Personal Information with any third party apart from financial institutions such as
                    ...
                    Information other than to provide the services requested by you.</p>
                    <p className="text-sm my-6">We may share your Personal Information with our parent company, subsidiaries, joint ventures, or other
                    ...
                    request that we receive.</p>
                    <p className="text-sm my-6">We may disclose information in the aggregate to third parties relating to User behavior in connection with
                    ...
                    <p className="text-3xl my-6 font-bold">Links</p>
                    <p className="text-sm my-6">References on this Website to any names, marks, products or services of third parties or hyperlinks to third
                    ...
                    websites.</p>
                    <p className="text-3xl my-6 font-bold">User access of Personal Information</p>
                    <p className="text-sm my-6">As a registered Razorpay User, you can modify some of your Personal Information and your privacy
                    preferences by accessing the "Account" section of this Website.</p>
                    <p className="text-3xl font-bold my-6">Security</p>
                    <p className="text-sm my-6">Your account is password protected. We use industry standard measures to protect the Personal Information
                    ...
                    have any questions about the security on Razorpay, please contact us at <a className="underline underline-offset-4" href="mailto:disclosures@razorpay.com">disclosures@razorpay.com</a>.</p>
                    <p className="text-sm my-6">You hereby acknowledge that Razorpay is not responsible for any intercepted information sent via the
                    ...
                    <p className="text-3xl my-6 font-bold">Terms and modifications to this Privacy Policy</p>
                    <p className="text-sm my-6">Our Privacy Policy is subject to change at any time without notice. To make sure you are aware of any
                    ...
                    to provide us with your most current e-mail address.</p>
                    <p className="text-sm my-6">If you do not wish to permit changes in our use of your Personal Information, you must notify us promptly
                    ...
                    <p className="text-3xl font-bold my-6">Applicable law</p>
                    <p className="text-sm my-6">Your use of this Website will be governed by and construed in accordance with the laws of India. The Users
                    ...
                    <p className="text-3xl font-bold my-6">Complaints and Grievance Redressal</p>
                    <p className="text-sm my-6">If you contact us to provide feedback, register a complaint, or ask a question, we will record any Personal
                    ...
                    mentioned below:</p>
                    <p className="text-3xl font-bold my-6">DPO</p>
                    <p className="text-sm my-6">Mr. SHASHANK KARINCHETI</p>
                    <p className="text-sm my-6">
                    Razorpay Software Private Limited</p>
                    <p className="text-sm my-6">Address: No. 22, 1st Floor, SJR Cyber, Laskar - Hosur Road, Adugodi, Bangalore - 560030</p>
                    <p className="text-sm my-6">
                    Ph: 080-46669555</p>
