    ...
    return (
        <div className="flex flex-col min-h-screen bg-black text-white">
            ...
            <main className="flex-grow flex flex-col lg:flex-row-reverse lg:justify-between items-center lg:items-start px-4 md:px-6 pt-8">
                ...
                >
                    <h2 className="text-[1.4em] font-geist absolute bottom-0 left-0 p-[1em] md:p-[1.6em]">
                        {team.name}
                    </h2>
                ...
                <div className="lg:w-[60%] lg:pr-8">
                    ...
                    <div className="w-full space-y-6 pt-8">
                        ...
                        <div className="space-y-4 w-full py-4 pb-8">
                            <div className="border-b-[1px] border-neutral-800 pb-8 w-full">
                                    ...
                                    {team.members &&
                                        team.members.map((member, index) => {
                                            ...
                                            return (
                                                <li
                                                    key={index}
                                                    className="flex items-center space-x-2 w-full lg:w-[35%] lg:bg-neutral-900 lg:rounded-lg lg:border-[1px] lg:border-neutral-600 lg:p-4 relative"
                                                >
                                                    <Avatar>
                                                        <AvatarImage
                                                            src={member.pfp}
                                                    ...
                                                    <Button
                                                        variant="destructive"
                                                        className="absolute top-[50%] right-2 hover:bg-gray-700 rounded-full rotate-45 -translate-y-1/2 text-md p-4"
                                                    >
                                                        +
                                                    </Button>
                                                </li>
