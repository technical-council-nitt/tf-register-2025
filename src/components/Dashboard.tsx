...
let problem_statements = [
  {
    value: "BS1 - McKinsey & Company",
    label: "BS1 - McKinsey & Company",
    domain: "management",
  },
  { value: "BCG Case Study", label: "BCG Case Study", domain: "management" },
  {
    value: "BOSCH - Smart Power Management Module",
    label: "BOSCH - Smart Power Management Module",
    domain: "hardware",
  },
  { value: "BHEL - PS01", label: "BHEL - PS01", domain: "hardware" },
  {
    value: "BHEL - Problem Statement 2",
    label: "BHEL - Problem Statement 2",
    domain: "hardware",
  },
  {
    value: "ZeroWings - Buck Converter",
    label: "ZeroWings - Buck Converter",
    domain: "hardware",
  },
  {
    value: "JCB - Quick-Hitch Problem Statement",
    label: "JCB - Quick-Hitch Problem Statement",
    domain: "hardware",
  },
  {
    value: "OptiSol - Problem Statement 1",
    label: "OptiSol - Problem Statement 1",
    domain: "software",
  },
  {
    value: "OptiSol - AI Powered Workflow Automation",
    label: "OptiSol - AI Powered Workflow Automation",
    domain: "software",
  },
  {
    value: "OptiSol - Problem Statement 2",
    label: "OptiSol - Problem Statement 2",
    domain: "software",
  },
  {
    value: "ZeroWings - Thermal Human Detection",
    label: "ZeroWings - Thermal Human Detection",
    domain: "software",
  },
  {
    value: "ZeroWings - Concrete Crack Detection",
    label: "ZeroWings - Concrete Crack Detection",
    domain: "software",
  },
  {
    value: "ZeroWings - Agriculture Drone",
    label: "ZeroWings - Agriculture Drone",
    domain: "software",
  },
  {
    value: "ZeroWings - Operation Lifeline",
    label: "ZeroWings - Operation Lifeline",
    domain: "software",
  },
  {
    value: "DARE 2 DREAM Problem Statement",
    label: "DARE 2 DREAM Statement",
    domain: "software",
  },
  {
    value: "DARE 2 DREAM Problem Statement",
  ...
  {
    value: "Stealth AI-Problem Statement",
    label: "Stealth AI  - Problem Statement",
    domain: "software",
  },

  {
    value: "CEDI - Under NAVIYA",
    label: "CEDI - Under NAVIYA",
    domain: "entrepreneurship",
  },
  {
    value: "RVC - Track Based Problem Statement",
    label: "RVC - Track Based Problem Statement",
    domain: "entrepreneurship",
  },
  {
    value: "RVC - Track Based Problem Statement",
 ...
 const finalform = useForm({
  ...
  useEffect(() => {
    ...
    if (currentDomain) {
      ...
      setFilteredPS(
        problem_statements.filter(
          (ps) => (ps.domain || "").toLowerCase() === lower
        )
      );
    } else {
  ...
  const init = async (): Promise<Order | undefined> => {
    try {
      ...
      console.log(
        "Environment variable VITE_PROD_URL_BACKEND:",
        import.meta.env.VITE_PROD_URL_BACKEND
      );
  ...
  const handlePay = async (): Promise<void> => {
    ...
    if (team?.members.length && team.members.length < 4) {
      ...
      toast("Whoops!", {
        description:
          "You need at least 4 members in your team to submit payment.",
      });
      return;
    }
  ...
  console.log("psactive", import.meta.env.VITE_PSACTIVE);
  ...
  return (
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 pr-0 w-11/12 md:w-1/3">
            ...
            <p className="mb-4 text-black">
              Please note that you will not be able to change the domain after
              payment.
            </p>
      ...
      <div className="flex flex-col justify-between h-full flex-grow">
        <div className="flex-grow flex flex-col lg:flex-row-reverse lg:justify-between items-center lg:items-start px-4 md:px-6 pt-8">
          <div className="flex-grow flex flex-col lg:flex-col  lg:justify-center lg:items-end md:items-center   ">
            ...
            >
              ...
              <div className="absolute bottom-0 right-0 p-6 pb-4">
                {(team.payment_status === "Pending" ||
                  ...
                  false &&
                  paymentCount <= +import.meta.env.VITE_TEAM_CAP &&
                  isLead && (
                    <Button
                      ...
                      <FormItem className="lg:w-full">
                        ...
                        <FormControl>
                          <Select
                            ...
                            value={field.value}
                            disabled={
                              !(isLead && team.payment_status === "Pending")
                            } // Disable if not lead or payment done
                          >
                            <SelectTrigger className="bg-[#1a1a1a] border border-gray-600 rounded-md w-[80vw] md:w-[40vw] lg:w-full">
                              <SelectValue
                                placeholder={
                                  team.domain ? team.domain : "Select Domain"
                                }
                              />
                            </SelectTrigger>
                      ...
                      <FormItem className="lg:w-full mt-5">
                        ...
                        <FormControl>
                          <Select
                            ...
                            value={field.value}
                            disabled={import.meta.env.VITE_PSACTIVE=== "false"} // Disable if not lead or payment done
                          >
                            <SelectTrigger className="bg-[#1a1a1a] border border-gray-600  rounded-md w-[80vw] md:w-[40vw] lg:w-full">
                              <SelectValue
            ...
            <Form {...foodform}>
              <form
                onSubmit={foodform.handleSubmit(onSubmitFood)}
                className="text-white  rounded-lg shadow-md lg:w-[100%]  md:w-[80vw] w-full space-y-2 mt-6 flex justify-center items-center  lg:justify-normal"
              >
                <div className="flex flex-col w-full">
                  <FormField
        ...
        {
          import.meta.env.VITE_MIDREVIEWACTIVE === 'true' && <Form {...midform}>
        <form
          onSubmit={midform.handleSubmit(onMidReviewSubmit)}
          className="text-white  rounded-lg shadow-md lg:w-[100%]  md:w-[80vw] w-full space-y-2 mt-6 flex justify-center items-center  lg:justify-normal"
        >
          <FormField
            name="file"
    ...
    {import.meta.env.VITE_FINALREVIEWACTIVE === 'true' &&
      <Form {...finalform}>
      <form
                  ...
                  <div className="pb-8 w-full h-full flex flex-col justify-between">
                    <ul className="flex flex-wrap gap-6 w-full">
                      {team.members &&
                        team.members
                          .sort((a) =>
                            a.user_id === team.leader_user_id ? -1 : 1
                          )
                          .map((member, index) => {
                            return (
                              <li
                      ...
                      {isLead ? (
                        <Dialog>
                          <DialogTrigger asChild>
                            ...
                            >
                              Discard Team{" "}
                              <FaRegTrashAlt className="text-[16px] ml-2" />
                            </Button>
                          </DialogTrigger>
                          <DialogContent className="sm:max-w-[425px]">
                            <DialogHeader>
                              ...
                              <DialogDescription>
                                Discarding this team will remove all members
                                from the team and erase its traces from our
                                servers. Are you sure you want to discard this
                                team?
                              </DialogDescription>
                            </DialogHeader>
                            <DialogFooter>
                      ...
                      {isLead && team.payment_status !== "PAID" && (
                        <>
                          {team.ispublic ? (
                            ...
                            >
                              Make Team Private{" "}
                              <FaLock className="text-[16px] ml-2" />
                            </Button>
                          ) : (
                            <Button
                              variant="outline"
                            ...
                            >
                              Make Team Public{" "}
                              <FaGlobe className="text-[16px] ml-2" />
                            </Button>
                          )}
